...
if (version_compare(elgg_get_version(true), '1.8') < 1) {
	...
	register_elgg_event_handler('foo', 'bar', 'callbackTrueGlobal');
	register_elgg_event_handler('foo', 'bar', array('ugly_plugin', 'callbackTrue'));
	register_plugin_hook('foo', 'bar', 'callbackTrueGlobal');
	register_plugin_hook('foo', 'bar', array('ugly_plugin', 'callbackTrue'));
